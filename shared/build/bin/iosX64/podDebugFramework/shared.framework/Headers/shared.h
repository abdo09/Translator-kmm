...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TranslateError")))
@interface SharedTranslateError : SharedKotlinEnum<SharedTranslateError *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) SharedTranslateError *serverUnavailable __attribute__((swift_name("serverUnavailable")));
@property (class, readonly) SharedTranslateError *clientError __attribute__((swift_name("clientError")));
@property (class, readonly) SharedTranslateError *serverError __attribute__((swift_name("serverError")));
@property (class, readonly) SharedTranslateError *unknownError __attribute__((swift_name("unknownError")));
+ (SharedKotlinArray<SharedTranslateError *> *)values __attribute__((swift_name("values()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TranslationErrorException")))
@interface SharedTranslationErrorException : SharedKotlinException
- (instancetype)initWithError:(SharedTranslateError *)error __attribute__((swift_name("init(error:)"))) __attribute__((objc_designated_initializer));
...
@protocol SharedHistoryDataSource
@required
- (SharedCommonFlow<NSArray<SharedHistoryItem *> *> *)getHistory __attribute__((swift_name("getHistory()")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)insertHistoryItemHistoryItem:(SharedHistoryItem *)historyItem completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("insertHistoryItem(historyItem:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HistoryItem")))
@interface SharedHistoryItem : SharedBase
- (instancetype)initWithId:(SharedLong * _Nullable)id fromLanguageCode:(NSString *)fromLanguageCode fromText:(NSString *)fromText toLanguageCode:(NSString *)toLanguageCode toText:(NSString *)toText __attribute__((swift_name("init(id:fromLanguageCode:fromText:toLanguageCode:toText:)"))) __attribute__((objc_designated_initializer));
- (SharedHistoryItem *)doCopyId:(SharedLong * _Nullable)id fromLanguageCode:(NSString *)fromLanguageCode fromText:(NSString *)fromText toLanguageCode:(NSString *)toLanguageCode toText:(NSString *)toText __attribute__((swift_name("doCopy(id:fromLanguageCode:fromText:toLanguageCode:toText:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *fromLanguageCode __attribute__((swift_name("fromLanguageCode")));
...
@property (readonly) NSString *toLanguageCode __attribute__((swift_name("toLanguageCode")));
@property (readonly) NSString *toText __attribute__((swift_name("toText")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SqlDelightHistoryDataSource")))
@interface SharedSqlDelightHistoryDataSource : SharedBase <SharedHistoryDataSource>
- (instancetype)initWithDb:(id<SharedTranslatorDatabase>)db __attribute__((swift_name("init(db:)"))) __attribute__((objc_designated_initializer));
- (SharedCommonFlow<NSArray<SharedHistoryItem *> *> *)getHistory __attribute__((swift_name("getHistory()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KtorTranslateClient")))
@interface SharedKtorTranslateClient : SharedBase <SharedTranslateClient>
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TranslateDto")))
@interface SharedTranslateDto : SharedBase
- (instancetype)initWithTextToTranslate:(NSString *)textToTranslate sourceLanguageCode:(NSString *)sourceLanguageCode targetLanguageCode:(NSString *)targetLanguageCode __attribute__((swift_name("init(textToTranslate:sourceLanguageCode:targetLanguageCode:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedTranslateDtoCompanion *companion __attribute__((swift_name("companion")));
- (SharedTranslateDto *)doCopyTextToTranslate:(NSString *)textToTranslate sourceLanguageCode:(NSString *)sourceLanguageCode targetLanguageCode:(NSString *)targetLanguageCode __attribute__((swift_name("doCopy(textToTranslate:sourceLanguageCode:targetLanguageCode:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *sourceLanguageCode __attribute__((swift_name("sourceLanguageCode")));
@property (readonly) NSString *targetLanguageCode __attribute__((swift_name("targetLanguageCode")));
@property (readonly) NSString *textToTranslate __attribute__((swift_name("textToTranslate")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TranslateDto.Companion")))
@interface SharedTranslateDtoCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedTranslateDtoCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TranslatedDto")))
@interface SharedTranslatedDto : SharedBase
- (instancetype)initWithTranslatedText:(NSString *)translatedText __attribute__((swift_name("init(translatedText:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedTranslatedDtoCompanion *companion __attribute__((swift_name("companion")));
- (SharedTranslatedDto *)doCopyTranslatedText:(NSString *)translatedText __attribute__((swift_name("doCopy(translatedText:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TranslatedDto.Companion")))
@interface SharedTranslatedDtoCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedTranslatedDtoCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
__attribute__((swift_name("TranslatorDatabase")))
@protocol SharedTranslatorDatabase <SharedRuntimeTransacter>
@required
@property (readonly) id<SharedTranslatorQueries> translatorQueries __attribute__((swift_name("translatorQueries")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TranslatorDatabaseCompanion")))
@interface SharedTranslatorDatabaseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
*/
- (void)collectCollector:(id<SharedKotlinx_coroutines_coreFlowCollector>)collector completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("collect(collector:completionHandler:)")));
- (id<SharedKotlinx_coroutines_coreDisposableHandle>)subscribeCoroutineScope:(id<SharedKotlinx_coroutines_coreCoroutineScope>)coroutineScope dispatcher:(SharedKotlinx_coroutines_coreCoroutineDispatcher *)dispatcher onCollect:(void (^)(T _Nullable))onCollect __attribute__((swift_name("subscribe(coroutineScope:dispatcher:onCollect:)")));
@end
...
@property (class, readonly) SharedLanguage *azerbaijani __attribute__((swift_name("azerbaijani")));
@property (class, readonly) SharedLanguage *chinese __attribute__((swift_name("chinese")));
@property (class, readonly) SharedLanguage *czech __attribute__((swift_name("czech")));
@property (class, readonly) SharedLanguage *danish __attribute__((swift_name("danish")));
@property (class, readonly) SharedLanguage *dutch __attribute__((swift_name("dutch")));
@property (class, readonly) SharedLanguage *finnish __attribute__((swift_name("finnish")));
@property (class, readonly) SharedLanguage *french __attribute__((swift_name("french")));
@property (class, readonly) SharedLanguage *german __attribute__((swift_name("german")));
@property (class, readonly) SharedLanguage *greek __attribute__((swift_name("greek")));
@property (class, readonly) SharedLanguage *hebrew __attribute__((swift_name("hebrew")));
@property (class, readonly) SharedLanguage *hindi __attribute__((swift_name("hindi")));
@property (class, readonly) SharedLanguage *hungarian __attribute__((swift_name("hungarian")));
@property (class, readonly) SharedLanguage *indonesian __attribute__((swift_name("indonesian")));
@property (class, readonly) SharedLanguage *irish __attribute__((swift_name("irish")));
@property (class, readonly) SharedLanguage *italian __attribute__((swift_name("italian")));
@property (class, readonly) SharedLanguage *japanese __attribute__((swift_name("japanese")));
@property (class, readonly) SharedLanguage *korean __attribute__((swift_name("korean")));
@property (class, readonly) SharedLanguage *persian __attribute__((swift_name("persian")));
@property (class, readonly) SharedLanguage *polish __attribute__((swift_name("polish")));
@property (class, readonly) SharedLanguage *portuguese __attribute__((swift_name("portuguese")));
@property (class, readonly) SharedLanguage *russian __attribute__((swift_name("russian")));
@property (class, readonly) SharedLanguage *slovak __attribute__((swift_name("slovak")));
@property (class, readonly) SharedLanguage *spanish __attribute__((swift_name("spanish")));
@property (class, readonly) SharedLanguage *swedish __attribute__((swift_name("swedish")));
@property (class, readonly) SharedLanguage *turkish __attribute__((swift_name("turkish")));
@property (class, readonly) SharedLanguage *ukrainian __attribute__((swift_name("ukrainian")));
+ (SharedKotlinArray<SharedLanguage *> *)values __attribute__((swift_name("values()")));
@property (readonly) NSString *langCode __attribute__((swift_name("langCode")));
@property (readonly) NSString *langName __attribute__((swift_name("langName")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HistoryEntity")))
@interface SharedHistoryEntity : SharedBase
- (instancetype)initWithId:(int64_t)id fromLanguageCode:(NSString *)fromLanguageCode fromText:(NSString *)fromText toLanguageCode:(NSString *)toLanguageCode toText:(NSString *)toText timestamp:(int64_t)timestamp __attribute__((swift_name("init(id:fromLanguageCode:fromText:toLanguageCode:toText:timestamp:)"))) __attribute__((objc_designated_initializer));
- (SharedHistoryEntity *)doCopyId:(int64_t)id fromLanguageCode:(NSString *)fromLanguageCode fromText:(NSString *)fromText toLanguageCode:(NSString *)toLanguageCode toText:(NSString *)toText timestamp:(int64_t)timestamp __attribute__((swift_name("doCopy(id:fromLanguageCode:fromText:toLanguageCode:toText:timestamp:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *fromLanguageCode __attribute__((swift_name("fromLanguageCode")));
...
__attribute__((swift_name("TranslatorQueries")))
@protocol SharedTranslatorQueries <SharedRuntimeTransacter>
@required
- (SharedRuntimeQuery<SharedHistoryEntity *> *)getHistory __attribute__((swift_name("getHistory()")));
- (SharedRuntimeQuery<id> *)getHistoryMapper:(id (^)(SharedLong *, NSString *, NSString *, NSString *, NSString *, SharedLong *))mapper __attribute__((swift_name("getHistory(mapper:)")));
- (void)insertHistoryEntityId:(SharedLong * _Nullable)id fromLanguageCode:(NSString *)fromLanguageCode fromText:(NSString *)fromText toLanguageCode:(NSString *)toLanguageCode toText:(NSString *)toText timestamp:(int64_t)timestamp __attribute__((swift_name("insertHistoryEntity(id:fromLanguageCode:fromText:toLanguageCode:toText:timestamp:)")));
@end

@interface SharedHistoryEntity (Extensions)
- (SharedHistoryItem *)toHistoryItem __attribute__((swift_name("toHistoryItem()")));
@end
